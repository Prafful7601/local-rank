        ...
        <div>
          <div style={{ background: C.surface, border: `1px solid ${C.border}`, borderRadius: "10px", padding: "24px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "13px" }}>
              ...
              <div>
                ...
                <div style={{ display: "flex", gap: "8px" }}>
                  <button
                    ...
                    style={{
                      ...
                      border: `1.5px solid ${reportType === "free" ? C.green : C.border}`,
                      background: reportType === "free" ? C.greenDim : "transparent",
                      color: reportType === "free" ? C.green : C.muted,
                    }}
                  >
                    Free (3 issues)
                  </button>
                  <button
                    ...
                    style={{
                      flex: 1, padding: "10px", borderRadius: "6px",
                      fontSize: "12px", fontWeight: 600, fontFamily: ff, cursor: "pointer",
                      border: `1.5px solid ${reportType === "full" ? C.gold : C.border}`,
                      background: reportType === "full" ? "rgba(245,158,11,0.12)" : "transparent",
                      color: reportType === "full" ? C.gold : C.muted,
                    }}
                  >
                    Full — $97
                  </button>
                ...
                {reportType === "full" && (
                  <div style={{ fontSize: "11px", color: C.gold, marginTop: "5px" }}>
                    Full report includes all issues, competitor table & fix plan — delivered by Prafful
                  </div>
                )}
              </div>
              ...
              {reportType === "full" ? (
                /* Full report → WhatsApp redirect */
                (() => {
                  const waMsg = encodeURIComponent(
                    `Hi Prafful! I'd like the full GBP audit report ($97) for:\n\nBusiness: ${business || "[your business]"}\nCity: ${city || "[your city]"}\nIndustry: ${niche}\n${gbpUrl ? `GBP URL: ${gbpUrl}\n` : ""}Can you send me the complete report with all issues, competitor analysis, and fix plan?`
                  );
                  return (
                    <a
                      ...
                      style={{
                        ...
                        textDecoration: "none", boxShadow: "0 0 20px rgba(245,158,11,0.25)",
                      }}
                    >
                      ...
                      Get Full Report on WhatsApp — $97
                    </a>
                  );
                })()
              ) : (
                ...
                >
                  ...
                  ) : gbpUrl.trim() ? "🤖 Analyze with AI" : "⚡ Generate Free Audit"}
                </button>
              )}
            </div>
          </div>
